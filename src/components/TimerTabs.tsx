...
function TimerTabsComponent({
  t
  secondsLeft,
  isPaused,
  switchPaused
}) {
  return <Tabs.Panel value={t.label} pt='xs'>
									<Stack align='center'>
										<Title order={1} sx={{
        fontSize: '4rem'
      }}>
										...
										<Button size='xl' rightIcon={isPaused ? <PlayIcon width={24} /> : <PauseIcon width={24} />} onClick={switchPaused}>
											{isPaused ? 'START' : 'STOP'}
										</Button>
									</Stack>
								</Tabs.Panel>;
